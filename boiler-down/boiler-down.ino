...
Скетч использует 24370 байт (9%) памяти устройства. Всего доступно 253952 байт.
Глобальные переменные используют 1464 байт (17%) динамической памяти, 
оставляя 6728 байт для локальных переменных. Максимум: 8192 байт.
/*****************************************************************************\
