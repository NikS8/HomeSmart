...
Скетч использует 23168 байт (75%) памяти устройства. Всего доступно 30720 байт.
Глобальные переменные используют 779 байт (38%) динамической памяти, 
оставляя 1269 байт для локальных переменных. Максимум: 2048 байт.
/*****************************************************************************\
...
/*~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~*\
            info
\*~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~*\
21.02.2020 v10 Перевод некоторых функций в классы
